...
set label 1 "Li^+" at 15,11 textcol rgb "black"

unset key
set label 3  "{n}" offset -3.5,3.5 rotate by 90
...
set ytics nomirror
set ytics add("" 0,"" 2,""4,""6,""8,""10,""12,""14)
...
set label 1 "Na^+" at 5,11 textcol rgb "red"
...
set ytics font "Times-Roman,15"
set label 1 "K^+" at 5,11 textcol rgb "green"
set size 0.45,0.55
set origin 0.5,0.05
...
unset label 2
unset object
set label 1 "Rb^+" at 5,11 textcol rgb "blue"

set size 0.45,0.55
set origin 0.75,0.05
...
# set xlabel "{ y/ [{\305}] }" font "Times-Roman,21" 
 set label 1 "Cs^+" at 5,11 textcol rgb "purple"

set label 2   " {t(ps) }" offset -19.8,-2.5 rotate by 0
unset ytics
set size 0.45,0.55
set origin 1,0.05
