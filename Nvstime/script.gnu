...
FIT_MAXIT=1000 
FIT_LIMIT=1e+06 
fit [0:18][] g(x)  'RbSpherical-average-spline' u 2:1 via A
fit [0:13][] f(x)  'RbSpherical-average-spline' u 2:1 via B 


p   f(x) lc rgb "brown" lw 2 lt 8  t ""  ,\
    "RbSpherical-average-spline" u 2:1 w p pt 4 pi 1 lc rgb "black" t "",\
     "Rbn5" u 1:2 w l  lw 2 lc rgb "black" t "" ,\
      z(x) lc rgb "black" lw 1 lt 8  t ""
...
p   f(x) lc rgb "brown" lw 2 lt 8  t ""  ,\
    "RbSpherical-average-spline" u 2:1 w p pt 4 pi 1 lc rgb "red" t "",\
     "Rbn5" u 1:2 w l  lw 2 lc rgb "black" t "" ,\
      z(x) lc rgb "black" lw 1 lt 8  t ""
#############################################################################################################################################
...
FIT_MAXIT=1000 
FIT_LIMIT=1e+06 
fit [0:18][] g(x)  'KSpherical-average-spline' u 2:1 via A
fit [0:13][] f(x)  'KSpherical-average-spline' u 2:1 via B 


p   f(x) lc rgb "brown" lw 2 lt 8  t ""  ,\
    "KSpherical-average-spline" u 2:1 w p pt 4 pi 1 lc rgb "green" t "",\
     "Kn5" u 1:2 w l  lw 2 lc rgb "black" t "" ,\
      z(x) lc rgb "black" lw 1 lt 8  t ""
...
p   f(x) lc rgb "brown" lw 2 lt 8  t ""  ,\
    "RbSpherical-average-spline" u 2:1 w p pt 4 pi 1 lc rgb "blue" t "",\
     "Rbn5" u 1:2 w l  lw 2 lc rgb "black" t "",\
     z(x) lc rgb "black" lw 1 lt 8  t ""
#############################################################################################################################################
...
FIT_MAXIT=1000 
FIT_LIMIT=1e+06 
fit [0:18][] g(x)  'CsSpherical-average-spline' u 2:1 via A
fit [0:13][] f(x)  'CsSpherical-average-spline' u 2:1 via B 


p   f(x) lc rgb "brown" lw 2 lt 8  t ""  ,\
    "CsSpherical-average-spline" u 2:1 w p pt 4 pi 1 lc rgb "purple" t "",\
     "Csn5" u 1:2 w l  lw 2 lc rgb "black" t "" ,\
         z(x) lc rgb "black"  lw 1 lt 8  t ""
